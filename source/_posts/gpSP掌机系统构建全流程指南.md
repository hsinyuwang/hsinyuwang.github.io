---
title: gpSP掌机系统构建全流程指南
date: 2022-07-02 15:38:29
tags: [嵌入式]
---
...
```
sudo apt-get install -y device-tree-compiler python flex bison ncurses-dev libssl-dev lsb-core lib32stdc++6
```
...
```
sudo tar xvf ~/v3s/buildroot-2019.08/output/rootfs.tar -C /挂载 tf 卡第二个分区目录
```
...
```
sudo tar xvf ~/v3s/buildroot-2019.08/output/rootfs.tar -C ~/img/rootfs
```
